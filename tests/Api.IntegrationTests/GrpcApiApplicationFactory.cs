...
namespace Codidact.Core.WebApp.IntegrationTests
{
    ...
    /// </summary>
    public class GrpcApiApplicationFactory<TStartup> : WebApplicationFactory<TStartup> where TStartup : class
    {
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder
                .ConfigureServices(services =>
                {
                    ...
                    var logger = scopedServices.GetRequiredService<ILogger<GrpcApiApplicationFactory<TStartup>>>();
